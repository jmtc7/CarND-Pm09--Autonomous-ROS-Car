...
class DBWNode(object):
    def __init__(self):
        ...
        # Get parameters from ROS Parameter Server (w/ default values)
        ...
        # Publishers for steering, throttle and braking
        ...
        # DONE: Subscribe to necessary topics
    ...
    def loop(self):
        # Publish at 50 Hz
        ## NOTE: 10 Hz or below and the car will switch to manual mode!
        rate = rospy.Rate(50)
